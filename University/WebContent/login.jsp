...
<div class="wrapper">
    ...
    <input type="hidden"  class="input"  name="viewType" value=""/>
        ...
        <li><a href="contactus.jsp"><span><span>Enquiry</span></span></a></li>
 ...
 <h3 class="pad_top1">Login</h3>
        ...
        <tr>
        <td>  Name: </td>
        <td> <input type="text"  class="input"  name="username" required="required" value="student"/></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr> <td>Password:</td>
            <td> <input type="password" class="input" name="userpass" required="required" value="student"/></td>
              </tr>
              <tr><td>&nbsp;</td></tr>
              <tr>
