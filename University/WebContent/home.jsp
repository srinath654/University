...
<div class="main">
 ...
 <h3 class="pad_top1">Search Courses</h3>
       ...
       <input type="hidden"  class="input"  name="viewType" value="search"/>
        ...
        <tr><td colspan="8">&nbsp;</td></tr>
           ...
           <tr><td>&nbsp;</td></tr>
            ...
            <tr>
            <td colspan="2"> 
            <core:if test="${user.userType!='Domestic' && (user.tbTest!='1' || user.mmr!='1' || user.mailed!='1' || user.status!='Approved')}">
             <font color="red">You cannot enroll courses as there are holds on your account. Please complete health screening process and contact administrator in case of issues.</font>
            </core:if>
    ...
    <td><core:out value="${course.type}"></core:out> </td>
     <core:if test="${user.userType=='Domestic' || (user.userType!='Domestic' && user.tbTest=='1' && user.mmr=='1' && user.mailed=='1' && user.status=='Approved')}">
