...
<div class="main">
	...
	<nav>
            <ul id="menu">
        <li><a href="adddepartments.jsp"><span><span>Modify Department Details</span></span></a></li>
     ...
     function myFunction() {
     	...
     	var flatType ='${student.tbTest}';
   	  selectObj = document.getElementById('tb');
 	  ...
 	  var mmr ='${student.mmr}';
   	  selectObj = document.getElementById('mmr');
   	  for(var j = 0; j < selectObj.length; j++) {
   			var flat = mmr.trim();
   	     if(selectObj.options[j].value.toLowerCase() == flat.toLowerCase()) {
   	       selectObj.options[j].selected = true;
   	...
   	var mailed ='${student.mailed}';
 	  selectObj = document.getElementById('mailed');
 	  for(var j = 0; j < selectObj.length; j++) {
 			var flat = mailed.trim();
 	     if(selectObj.options[j].value.toLowerCase() == flat.toLowerCase()) {
 	       selectObj.options[j].selected = true;
 	     }
 	  }
  ...
  <section id="content">
    <div class="wrapper pad1">
      ...
      <article class="col2">
        ...
        <td>  <select name="mailed" id="mailed">
         <option value="1" selected>Yes</option>
        <option value="0">No</option>
        </select>  
                </td>
